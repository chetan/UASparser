...
public class MultithreadedUASparser extends SingleThreadedUASparser {
    ...
    private final ThreadLocal<Map<Matcher, Long>> compiledBrowserMatcherMapT = new ThreadLocal<Map<Matcher, Long>>() {
        @Override
    ...
    private final ThreadLocal<Map<Matcher, Long>> compiledOsMatcherMapT = new ThreadLocal<Map<Matcher, Long>>() {
        @Override
        protected Map<Matcher, Long> initialValue() {
